...
hold off;
clear; clf;               % clear variables and functions from memory
hold on;

out = load('1e5walks');  % load the walks from other program
...
Np = 1e5;       % same number of particles as numerical
dr = 0.05;      % delta r, from the question
d = 0.01;       % d, from the question
r = binedges;   % use the same bins as numerical as they will be on the 
                % same graph

n = 2000;       % timestep is the number of jumps
